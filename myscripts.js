...
function sendMail(){
  var link = "mailto:gnomatix.music@gmail.com"+"?cc="
  + encodeURIComponent(document.getElementById("email").value)+"&subject="
  + encodeURIComponent(document.getElementById("subject").value)+"&body="
